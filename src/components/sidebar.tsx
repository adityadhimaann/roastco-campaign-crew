...
export function AppSidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "hidden md:flex fixed inset-y-0 left-0 z-50 bg-sidebar text-sidebar-foreground flex-col transition-all duration-200 overflow-hidden",
          "md:translate-x-0",
      ...
      >
        <div
          className={cn(
            ...
            open ? "px-6" : "md:px-0 md:justify-center"
          )}
        >
          <div className={cn("flex items-center gap-2.5 flex-1", !open && "hidden")}>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  open ? "px-3" : "md:px-0 md:justify-center",
                  active
              ...
              >
                ...
                <span className={cn("truncate", !open && "hidden")}>{item.title}</span>
              </Link>
            );
          })}
        </nav>
        <div className={cn("px-6 py-4 border-t border-sidebar-border text-xs text-sidebar-foreground/50 whitespace-nowrap overflow-hidden", !open && "hidden")}>
